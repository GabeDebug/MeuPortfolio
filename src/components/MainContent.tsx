...
const certificates = [
  { title: "Full-Stack Developer", org: "Udemy", year: "2025" },
];
      ...
      <section className="animate-fade-in" style={{ animationDelay: "0.3s" }}>
        ...
        <div className="flex items-center justify-between rounded-lg bg-card border border-border px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">Universidade Federal</p>
              <p className="text-xs text-muted-foreground">Analise e desenvolvimento de sistemas</p>
            </div>
          </div>
